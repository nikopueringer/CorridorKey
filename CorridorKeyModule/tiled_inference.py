...
class TiledInferenceEngine:
    ...
    def forward_tiled(
        ...
        # Ensure blend_ramp is on the correct device
        ...
        for tile in self.tiles:
            ...
            # Concatenate alpha [1,1,H,W] and fg [1,3,H,W] → [1,4,H,W]
            tile_out = torch.cat([tile_pred["alpha"], tile_pred["fg"]], dim=1)

            # Blend and accumulate
        ...
        # Log peak VRAM after first frame on CUDA
        ...
        # Normalize by weight sum and crop to original size
