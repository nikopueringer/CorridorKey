"""Engine factory - selects Torch or MLX engine and normalizes output contracts."""
...
def _wrap_mlx_output(raw: dict, despill_strength: float, auto_despeckle: bool, despeckle_size: int) -> dict:
    ...
    """
    from corridorkey_core import compositing as cu
...
def create_engine(
    ...
    Args:
        backend: "auto", "torch", or "mlx". Defaults to auto-detect.
        device: Torch device string (e.g. "cuda", "cpu"). Ignored for MLX.
    ...
    Returns:
        An engine instance with a process_frame() method matching the Torch contract.
    """
